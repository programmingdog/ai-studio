...
export interface ReferralRecord { id: string; amount_fen?: number | string; base_amount_fen?: number | string; rate_bps?: number; level?: number; status?: string; status_note?: string; review_note?: string; created_at: string; paid_at?: string; credits?: number; source_credits?: number | string; cost_credits?: number | string | null; profit_credits?: number | string | null; cny_per_credit?: number | string | null; source_capability?: string; consumption_record_id?: string; payer_id?: string; invited_user_id?: string; alipay_trade_no?: string }
