...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::import_asset_library_item,
            commands::get_asset_library_workspace,
            ...
            commands::get_latest_automatic_workflow,
            ...
            ai::analyze_video,
            ai::generate_asset_library_item,
            ...
            ai::prepare_video_reference_assets,
