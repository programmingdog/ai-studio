...
export class ClientConfigController {
  constructor(
    ...
    @Inject(ClientRuntimeConfigService) private readonly runtimeConfig: ClientRuntimeConfigService,
  ) {}
  ...
  async bootstrap(): Promise<Record<string, unknown>> {
    return {
      ...
      recommended_video_concurrency: await this.runtimeConfig.effectiveVideoConcurrency(),
    };
  }
